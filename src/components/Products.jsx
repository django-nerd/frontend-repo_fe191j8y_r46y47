...
const ProductCard = ({ icon: Icon, title, subtitle, points }) => (
  <div className="relative overflow-hidden rounded-2xl border bg-white p-6 text-slate-900 shadow-xl" style={{ borderColor: `${BRAND}22` }}>
    <div className="relative z-10">
      <div className="mb-4 inline-flex items-center justify-center rounded-xl p-3" style={{ backgroundColor: `${BRAND}0D` }}>
        <Icon className="h-6 w-6" style={{ color: BRAND }} />
      </div>
      <h3 className="text-xl font-semibold" style={{ color: BRAND }}>{title}</h3>
...
export default function Products() {
  return (
    <section className="relative w-full bg-gradient-to-b from-white to-slate-50 py-20 text-slate-900">
      <div className="mx-auto max-w-7xl px-6">
        <div className="mx-auto max-w-3xl text-center">
          <h2 className="text-3xl font-bold sm:text-4xl" style={{ color: BRAND }}>Core Products</h2>
